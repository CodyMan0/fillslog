...
export const DATE_FORMAT_YYYY_MM_DD_HH_mm = "YY-MM-DD HH:mm";
export const DATE_FORMAT_DD_MM_YYYY = "DD-MM-YYYY";
export const DATE_FORMAT_MM_DD_IN_KOREAN = "MM월 DD일";
export const DATE_FORMAT_MM_IN_KOREAN = "M월";
export const DATE_FORMAT_DD_MM_YYYY_WITH_DOT_IN_ENG = "DD.MM.YYYY";
export const DATE_FORMAT_DD_MM_YYYY_WITH_DOT_IN_KOR = "YYYY.MM.DD";
export const DATE_FORMAT_DD_MM_mm_YYYY_WITH_DOT_IN_KOR = "YYYY.MM.DD HH:mm";
...
export const DATE_FORMAT_YYYY_MM_DDTHH_mm = "YYYY-MM-DD HH:mm";
