...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[430px] border-t border-zinc-800 bg-main text-sm flex justify-around items-center h-16 z-50">
      {navItems.map((item) => {
